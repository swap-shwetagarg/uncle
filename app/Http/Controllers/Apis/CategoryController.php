...
class CategoryController extends Controller {
    ...
    public function index() {
        $result = $this->category->findAll(1);
    ...
    public function store(CategoryFormRequest $request) {
        ...
        if ($result === true) {
            return response()->json(['status' => 'success', 'message' => 'Category is added Successfully'], 200);
        } else {
            return response()->json(['status' => 'error', 'message' => 'Category is not added'], 400);
        }
    }
    ...
    public function update(UpdateCategoryRequest $request, $id) {
        ...
        if ($result === true) {
            return response()->json(['status' => 'success', 'message' => 'Category is updated Successfully'], 200);
        } else {
            return response()->json(['status' => 'error', 'message' => 'Category is not updated'], 400);
        }
    }
    ...
    public function destroy($id) {
        ...
        if ($result) {
            return response()->json(['status' => 'success', 'message' => 'Category is deleted Successfully'], 200);
        } else {
