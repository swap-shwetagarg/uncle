...
use AuthenticatesUsers;
    ...
    public function login(Request $request) {
        ...
        $user = User::whereEmail($request->email)->orWhere('mobile',$request->email)->first();
        if(!is_null($user)){
            ...
            if ( Auth::validate($credentials) ) {
                ...
                if ($request->ajax()) {
                ...
                } elseif (Auth::user()->hasRole('User') && Auth::user()->verified) {
                    ...
                    return redirect()->intended('/mechanic/profile');
                } else {
