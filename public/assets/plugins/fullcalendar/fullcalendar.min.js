...
! function(t) {
    ...
    function ft(t, e) {
        var n, i;
        return "string" == typeof e ? e : (n = e.token) ? se[n] ? se[n](t) : ct(t, n) : e.maybe && (i = ht(t, e.maybe), i.match(/[1-9]/)) ? i : ""
    }

    function gt(t, e, n, i, r) {
        var s;
        return t = qt.moment.parseZone(t), e = qt.moment.parseZone(e), s = t.localeData(), n = s.longDateFormat(n) || n, i = i || " - ", pt(t, e, mt(n), i, r)
    }
    ...
    function Dt(t) {
        function e(t) {
            return new bt(function(e) {
                var i = function() {
                    bt.resolve(t()).then(e).then(function() {
    ...
    function Mt(n) {
        var i, r, s, o, l = qt.dataAttrPrefix;
    ...
    function _t(n, i) {
        ...
        function l() {
            Q && Q.removeElement(), W.proxyCall("removeElement"), q.remove(), n.removeClass("fc fc-ltr fc-rtl fc-unthemed ui-widget"), n.off(".fc"), K && t(window).unbind("resize", K)
        }
        ...
        _.bindOptions(["locale", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"], function(t, e, n, i, s, o, l) {
            ...
            var t;
            return "local" === _.options.timezone ? (t = qt.moment.apply(null, arguments), t.hasTime() && t.local()) : t = "UTC" === _.options.timezone ? qt.moment.utc.apply(null, arguments) : qt.moment.parseZone.apply(null, arguments), r(t), t
            ...
            var n = e.clone();
            return t ? n.stripTime().add(_.defaultAllDayEventDuration) : n.add(_.defaultTimedEventDuration), _.getIsAmbigTimezone() && n.stripZone(), n
        ...
        var W, U, j, q, $, Q, X, K, J, tt = n[0],
            et = {},
            nt = 0;
        J = null != _.options.defaultDate ? _.moment(_.options.defaultDate).stripZone() : _.getNow(), _.getSuggestedViewHeight = function() {
            return void 0 === X && f(), X
        ...
        }, _.freezeContentHeight = F, _.thawContentHeight = N;
        var it = 0;
        _.initialize()
    }
    ...
    function Ut() {
        ...
        function u(t, e) {
            var n, i;
            for ("reset" === e ? nt = [] : "add" !== e && (nt = C(nt, t)), n = 0; n < t.length; n++) i = t[n], "pending" !== i._status && et++, i._fetchId = (i._fetchId || 0) + 1, i._status = "pending";
            for (n = 0; n < t.length; n++) i = t[n], c(i, i._fetchId);
            return et ? new bt(function(t) {
        ...
        function f(e, n) {
            ...
            var o = e.events;
            if (o) t.isFunction(o) ? (U.pushLoading(), o.call(U, q.clone(), Z.clone(), U.options.timezone, function(t) {
                n(t), U.popLoading()
            })) : t.isArray(o) ? n(o) : n();
            else {
                var l = e.url;
        ...
        function p(e) {
            var n, i, r = qt.sourceNormalizers;
        ...
        function M(e) {
            ...
            for (null == e ? e = function() {
                    ...
                    return t._id == n
                }), nt = t.grep(nt, e, !0), r = 0; r < tt.length; r++) t.isArray(tt[r].events) && (tt[r].events = t.grep(tt[r].events, e, !0));
            i()
        }
        ...
        function W(e, n, i, r, s, o) {
            ...
            return r && !r.valueOf() && (r = null), s && !s.valueOf() && (s = null), t.each(e, function(e, u) {
                    ...
                    c = {
                        ...
                        allDay: i
                    }, V(d), n ? d.end = null : s && !d.end && (d.end = U.getDefaultEventEnd(d.allDay, d.start)), r && (d.start.add(r), d.end && d.end.add(r)), s && d.end.add(s), l && !d.allDay && (r || s) && (d.start.stripZone(), d.end && d.end.stripZone()), t.extend(u, o, d), jt(u), a.push(function() {
                        t.extend(u, c), jt(u)
                    })
                }),
                function() {
    ...
    re.push("_fullCalendar"), re.push("_ambigTime"), re.push("_ambigZone"), qt.moment = function() {
        return ut(arguments)
    ...
    }, ne.week = ne.weeks = function(t) {
        var e = this._locale._fullCalendar_weekCalc;
        return null == t && "function" == typeof e ? e(this) : "ISO" === e ? ie.isoWeek.apply(this, arguments) : ie.week.apply(this, arguments)
    }, ne.time = function(t) {
        ...
        return this._fullCalendar && arguments[0] ? dt(this, arguments[0]) : this._ambigTime ? ct(this, "YYYY-MM-DD") : this._ambigZone ? ct(this, "YYYY-MM-DD[T]HH:mm:ss") : ie.format.apply(this, arguments)
    }, ne.toISOString = function() {
        return this._ambigTime ? ct(this, "YYYY-MM-DD") : this._ambigZone ? ct(this, "YYYY-MM-DD[T]HH:mm:ss") : ie.toISOString.apply(this, arguments)
    };
    var se = {
        t: function(t) {
    ...
    qt.queryMostGranularFormatUnit = function(t) {
    ...
    }, qt.Class = St, St.extend = function() {
        var t, e, n = arguments.length;
        for (t = 0; t < n; t++) e = arguments[t], t < n - 1 && Et(this, e);
        return wt(this, e || {})
    }, St.mixin = function(t) {
        Et(this, t)
    }, qt.Promise = bt, bt.immediate = !0, bt.resolve = function(e) {
        ...
        return s ? bt.resolve(n) : t.when.apply(t.when, e).then(function() {
    ...
    var ue = qt.EmitterMixin = {
        ...
        ge = qt.DragListener = St.extend(ce, de, {
            ...
            bindHandlers: function() {
                ...
                }), !C(this.handleTouchScrollProxy) && this.scrollEl && this.listenTo(this.scrollEl, "scroll", this.handleTouchScroll)) : this.listenTo(t(document), {
    ...
    var pe = ge.extend({
            ...
            handleInteractionStart: function(t) {
                ...
                this.computeCoords(), t ? (n = {
                    left: w(t),
                    top: E(t)
                }, i = n, r && (e = h(r), i = x(i, e)), this.origHit = this.queryHit(i.left, i.top), r && this.options.subjectCenter && (this.origHit && (e = R(this.origHit, e) || e), i = I(e)), this.coordAdjust = k(i, n)) : (this.origHit = null, this.coordAdjust = null), ge.prototype.handleInteractionStart.apply(this, arguments)
            },
        ...
        me = qt.Grid = St.extend(ce, de, {
            ...
            dayTouchStart: function(t) {
                ...
                (e.isSelected || e.selectedEvent) && this.tempIgnoreMouse(), null == n && (n = e.opt("longPressDelay")), this.dayDragListener.startInteraction(t, {
                    delay: n
                })
            },
    ...
    me.mixin({
        ...
        handleSegMouseover: function(t, e) {
            this.isIgnoringMouse || this.mousedOverSeg || (this.mousedOverSeg = t, this.view.isEventResizable(t.event) && t.el.addClass("fc-allow-mouse-resize"), this.view.publiclyTrigger("eventMouseover", t.el[0], t.event, e))
        },
        ...
        invertRanges: function(t) {
            var e, n, i = this.view,
                ...
                o = [],
                l = r;
            for (t.sort(Lt), e = 0; e < t.length; e++) n = t[e], n.start > l && o.push({
                start: l,
                end: n.start
            }), l = n.end;
            return l < s && o.push({
    ...
    var ye = qt.DayTableMixin = {
            ...
            renderHeadDateCellHtml: function(t, e, n) {
                ...
                return 1 === this.rowCnt ? r = r.concat(this.getDayClasses(t, !0)) : r.push("fc-" + Xt[t.day()]), '<th class="' + r.join(" ") + '"' + (1 === this.rowCnt ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (e > 1 ? ' colspan="' + e + '"' : "") + (n ? " " + n : "") + ">" + i.buildGotoAnchorHtml({
                    date: t,
        ...
        Se = qt.DayGrid = me.extend(ye, {
            ...
            renderDates: function(t) {
                ...
                for (this.el.html(o), this.rowEls = this.el.find(".fc-row"), this.cellEls = this.el.find(".fc-day"), this.rowCoordCache = new fe({
                        els: this.rowEls,
                        isVertical: !0
    ...
    var we = qt.TimeGrid = me.extend(ye, {
        ...
        renderDates: function() {
            this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day"), this.slatContainerEl = this.el.find(".fc-slats"), this.slatEls = this.slatContainerEl.find("tr"), this.colCoordCache = new fe({
                els: this.colEls,
                isHorizontal: !0
    ...
    var Ee = qt.View = St.extend(ue, ce, {
            ...
            buildGotoAnchorHtml: function(e, n, i) {
                var r, s, o, l;
                return t.isPlainObject(e) ? (r = e.date, s = e.type, o = e.forceOff) : r = e, r = qt.moment(r), l = {
            ...
            executeDateRender: function(t) {
                var e = this;
                return t ? this.captureInitialScroll() : this.captureScroll(), this.freezeHeight(), this.executeDateUnrender().then(function() {
            ...
            whenEventsSet: function() {
                var t = this;
                return this.isEventsSet ? bt.resolve(this.getCurrentEvents()) : new bt(function(e) {
                    t.one("eventsSet", e)
                })
            },
            ...
            executeEventsUnrender: function() {
                return this.isEventsRendered && (this.onBeforeEventsUnrender(), this.captureScroll(), this.freezeHeight(), this.destroyEvents && this.destroyEvents(), this.unrenderEvents(), this.thawHeight(), this.releaseScroll(), this.isEventsRendered = !1, this.trigger("eventsUnrender")), bt.resolve()
            },
    ...
    var De = qt.Calendar = St.extend({
        ...
        getUnitViewSpec: function(e) {
            var n, i, r;
            if (t.inArray(e, Kt) != -1)
                for (n = this.header.getViewsWithButtons(), t.each(qt.views, function(t) {
                        n.push(t)
                    }), i = 0; i < n.length; i++)
                    if (r = this.getViewSpec(n[i]), r && r.singleUnit == e) return r
        },
        buildViewSpec: function(t) {
            for (var i, r, s, o, l = this.overrides.views || {}, a = [], u = [], c = [], d = t; d;) i = Zt[d], r = l[d], d = null, "function" == typeof i && (i = {
                class: i
        ...
        buildViewSpecOptions: function(t) {
            t.options = n([De.defaults, t.defaults, this.dirDefaults, this.localeDefaults, this.overrides, t.overrides, this.dynamicOverrides]), Yt(t.options)
        },
    ...
    qt.datepickerLocale = function(e, n, i) {
        ...
        var r, s;
        r = Te[e] || (Te[e] = {}), i && (r = Te[e] = n([r, i])), s = Wt(e), t.each(He, function(t, e) {
            null == r[t] && (r[t] = e(s, r))
    ...
    var Le = qt.BasicView = Ee.extend({
            ...
            headRowEl: null,
            initialize: function() {
                this.dayGrid = this.instantiateDayGrid(), this.scroller = new be({
                    overflowX: "hidden",
                    overflowY: "auto"
                })
            },
            ...
            setRange: function(t) {
                Ee.prototype.setRange.call(this, t), this.dayGrid.breakOnWeeks = /year|month|week/.test(this.intervalUnit), this.dayGrid.setRange(t)
            },
            computeRange: function(t) {
        ...
        Be = qt.MonthView = Le.extend({
            computeRange: function(t) {
                var e, n = Le.prototype.computeRange.call(this, t);
    ...
    var ze = qt.AgendaView = Ee.extend({
            ...
            bottomRuleEl: null,
            initialize: function() {
                this.timeGrid = this.instantiateTimeGrid(), this.opt("allDaySlot") && (this.dayGrid = this.instantiateDayGrid()), this.scroller = new be({
                    overflowX: "hidden",
                    overflowY: "auto"
                })
            },
    ...
    var Ae = Ee.extend({
            ...
            scroller: null,
            initialize: function() {
                this.grid = new Ve(this), this.scroller = new be({
                    overflowX: "hidden",
                    overflowY: "auto"
                })
            },
