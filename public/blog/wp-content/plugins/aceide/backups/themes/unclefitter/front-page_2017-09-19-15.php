...
if ( file_put_contents ( "/var/www/html/public/blog/wp-content/themes/unclefitter/front-page.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/var/www/html/public/blog/wp-content/plugins/aceide/backups/themes/unclefitter/front-page_2017-09-19-15.php" ) ) ) ) {
             	...
             	<div class="post-entry">
					<?php if ( has_post_thumbnail() ) : 
						...
						<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
				            <img class="slide-image" src="<?php echo $large_image_url[0];?>" alt="" />
