...
if ( file_put_contents ( "/var/www/html/public/blog/wp-content/themes/unclefitter/single.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/var/www/html/public/blog/wp-content/plugins/aceide/backups/themes/unclefitter/single_2017-09-19-15.php" ) ) ) ) {
					...
					<div class="blog-single-content-sec">
					  <div class="blog-single-content-sec-inner">
					        <?php if ( has_post_thumbnail() ) : 
							     ...
							     <img class="slide-image-single" src="<?php echo $large_image_url[0];?>" alt="" />
