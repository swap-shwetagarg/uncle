    ...
    <div class="panel-body">
        ...
        <div>
            ...
            <div class="row price-breakdown-row">               
                @if(!in_array($booking->status, array(3, 4)))
                ...
                <div class="price-breakdown-column">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 text-right">
                        <div class="input-group">
                            ...
                            <input type="text" name="parts_cost" value="{{$booking->parts_cost}}" id="parts_cost" 
                                   class="pull-right form-control price-input" placeholder="Parts Price" />
                        </div>
                    </div>
                </div>
                <div class="price-breakdown-column">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 text-right">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1">&#x20B5;</span>
                            <input type="text" name="labour_cost" value="{{$booking->labour_cost}}" id="labour_cost" 
                                   class="pull-right form-control price-input" placeholder="Labour Price" />
                        </div>
                    </div>
                </div>
                <div class="price-breakdown-column">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 text-right">
                        &#x20B5;<span class="total_price_place">{{{ $booking->price or '0.00' }}}</span>
                    </div>
                </div>
                @endif
            </div>
...
<div class="modal-footer">
    ...
    <a href="updateBookingStatus" id="update-quote"   class="btn btn-success">
        @if($booking->status==4)
        Send Quote
        @else
        Update Quote
    ...
    <a href="{{ URL("admin/bookings/update-services/".$booking->id) }}" class="btn btn-info">Update Service(s)</a>
