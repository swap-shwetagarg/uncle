                                                                                    ...
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                            <td valign="top" class="textContent">
                                                                                                ...
                                                                                                <h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Hi,</h3>
                                                                                                <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;;margin-top:5px;color:#5F5F5F;line-height:135%;">Your booking (<b>Booking Id : <?php echo $booking['booking_id'] ;?> </b>) has been cancelled.</div>
                                                                                            </td>
                                                                                        </tr>                                                                            
                                                                                    </table>
                                                                                    <!-- // CONTENT TABLE -->
