                                                                                    ...
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                            <td valign="top" class="textContent">
                                                                                                ...
                                                                                                <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;;margin-top:5px;color:#5F5F5F;line-height:135%;"><b>For Booking Id : <?php  echo $event->id;?> User Schedule booking on <?php  echo TimeZone::getShortFormatedDate($event->schedule_date).' at '.$event->schedule_start_time;?></b></div>
                                                                                            </td>
                                                                                        </tr>                                                                            
                                                                                    </table>
                                                                                    <!-- // CONTENT TABLE -->
