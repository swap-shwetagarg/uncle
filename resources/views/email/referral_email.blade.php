                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tbody><tr>
                                                            <td valign="top" class="textContent">
                                                                <div mc:edit="body" style="padding: 40px;text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                    Your friend <strong class="capitalize"> {{$data['user_name']}}</strong> thought you should try us for your next car service, , repair or diagnostics so we are rewarding you with &#x20B5; 30.<br/><br/>
                                                                    ...
                                                                    Click <a href="{{$data['referral_link']}}">{{$data['referral_link']}}</a> today to sign up and get &#x20B5; 30 off.<br/><br/>
